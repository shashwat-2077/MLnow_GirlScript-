...
> 👩🏻‍💻  This repository is a code archive for the `ML.now()` course codes [Version 2.0] created by [Shashwat Pattanayak](https://github.com/shashwat-2077)
...
```
$ git clone https://github.com/shashwat-2077/MLnow_2.0.git
$ cd MLnow_2.0
```

### To Contribute

- Please [create a pull request](https://github.com/shashwat-2077/MLnow_2.0/pulls) so the main code is still up and running
